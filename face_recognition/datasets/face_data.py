...
class FaceData:
    ...
    def __init__(self):
        ...
        self.label_file_path = '../../face_recognition/datasets/labels.csv'
        self.image_w = 128
        self.image_h = 128

    def get_labels(self, label_file_path='../../face_recognition/datasets/labels.csv'):
    ...
    def pre_processing(self,
                       label_file_path='../../face_recognition/datasets/labels.csv',
        ...
        np.save("../../face_recognition/datasets/img_data.npy", (x_train, x_test))
        np.save("../../face_recognition/datasets/label_data.npy", (y_train, y_test))

        # return x_train, x_test, y_train, y_test

    def get_data(self,
                 img_data_path = '../../face_recognition/datasets/img_data.npy',
                 label_data_path = '../../face_recognition/datasets/label_data.npy'):
...
if __name__ == '__main__':
    ...
    faceData = FaceData()
    faceData.pre_processing()
    (x_train, x_test), (y_train, y_test) = faceData.get_data()
